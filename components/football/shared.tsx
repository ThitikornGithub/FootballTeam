...
export function TeamShirtIcon({
  ...
  return (
    <svg
      viewBox="0 0 64 64"
      className={`${classes} shrink-0 drop-shadow-sm ${className}`}
      aria-hidden="true"
    >
      <path
        d="M22 7 10 12 3 26l10 5 5-8v34h28V23l5 8 10-5-7-14-12-5c-2 5-18 5-20 0Z"
        fill={COLOR_HEX[color]}
        stroke={isWhite ? '#94a3b8' : '#fff'}
  ...
  return (
    <header className="sticky top-0 z-30 flex min-h-[70px] items-center gap-3 border-b border-slate-200/80 bg-white/95 px-4 pb-3 pt-[max(12px,env(safe-area-inset-top))] backdrop-blur">
      ...
      <div className="min-w-0 flex-1">
        {eyebrow && (
          <p
            className="truncate text-xs font-black uppercase tracking-[.1em] text-[#11823b]"
            title={eyebrow}
          >
            {eyebrow}
          </p>
