...
หากทีมหนึ่งถูกระบุว่า `absentToday` ครบทุกคน กระดานแท็กติกจะ fallback มาใช้รายชื่อทั้งทีมเพื่อไม่ให้ผู้เล่นฝั่งนั้นหายทั้งชุด และหน้ากระดานจะ remount เมื่อ roster หรือ tactics ล่าสุดจาก Neon เปลี่ยน เพื่อไม่ค้างอยู่กับ snapshot จาก cache
