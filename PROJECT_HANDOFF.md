...
- เลือกคู่เปิดสนามตอนสร้างเกม และเลือก 1–2 เกมถัดไปจากหน้าตั้งค่า เมื่อเริ่มแข่งแล้วระบบจะเก็บเกม current ไว้และ reshuffle เฉพาะ upcoming แบบ round robin
